...
If you just want to confirm webpack works with a minimal setup (before going through the full tutorial), follow these steps.
...
If everything worked, webpack will generate `dist/main.js`.

T> `src/` is where you write your source code. `dist/` is generated output — you typically don’t edit files in `dist/` by hand.
